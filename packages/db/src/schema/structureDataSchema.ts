...
import { JsonLdBlock, BreadcrumbItem, HTMLStructureDataType } from "@repo/config/types/urlInformationType/htmlStructureDataTypes";
...
const jsonLdBlockSchema = new Schema<JsonLdBlock>(jsonLdBlockSchemaDefination, { _id: false, versionKey: false, strict: true });
const breadCrumbSchema = new Schema<BreadcrumbItem>(breadCrumbSchemaDefination, { _id: false, versionKey: false, strict: true });
...
export const htmlStructureDataSchema = new Schema<HTMLStructureDataType>(htmlStructureDataSchemaDefination, { _id: false, versionKey: false, strict: true });