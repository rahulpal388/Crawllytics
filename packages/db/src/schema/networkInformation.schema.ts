import { EachUrlNetworkResultTypes, RedirectChainType } from "@repo/config/types/urlInformationType/eachUrlNetworkTypes";
...
const redirectChainSchema = new Schema<RedirectChainType>(redirectChainSchemaDefinition, { _id: false, versionKey: false })
...
export const urlNetworkSchema = new Schema<EachUrlNetworkResultTypes>(urlNetworkDefinition, { _id: false, versionKey: false, strict: true });