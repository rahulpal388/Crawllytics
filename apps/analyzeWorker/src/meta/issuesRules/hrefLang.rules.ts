...
export const hreflangRules: RulesType<PageMetaAnalysis, MetaIssueCode>[] = [
  // ===========================
  // Existence
  // ===========================
...

  {
    ...
    severity: "low",
    scoreImpact: 3,
    check: (data) => data.hreflang.hasHreflang && !data.hreflang.hasDefaultHreflang,
  },
...

  {
    ...
    severity: "warning",
    scoreImpact: 8,
    check: (data) => data.hreflang.hasHreflang && !data.hreflang.hasReturnHreflang,
  },
