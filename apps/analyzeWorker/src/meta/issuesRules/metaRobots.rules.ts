...
export const metaRobotsRules: RulesType<PageMetaAnalysis, MetaIssueCode>[] = [
  // ===========================
  // Existence
  // ===========================
...

  {
    ...
    severity: "critical",
    scoreImpact: 20,
    check: (data) => data.metaRobots.metaIndex && data.metaRobots.metaNoindex,
  },

  {
    ...
    severity: "high",
    scoreImpact: 10,
    check: (data) => data.metaRobots.metaFollow && data.metaRobots.metaNofollow,
  },
...

  {
    ...
    severity: "warning",
    scoreImpact: 5,
    check: (data) => data.metaRobots.metaIndexIfEmbedded && !data.metaRobots.metaNoindex,
  },
