...
export const twitterCardRules: RulesType<PageMetaAnalysis, MetaIssueCode>[] = [
  // ===========================
  // Existence
  // ===========================
...

  {
    ...
    severity: "warning",
    scoreImpact: 5,
    check: (data) => data.twitterCard.hasTwitterCard && !data.twitterCard.hasTwitterCardType,
  },

  {
    ...
    severity: "warning",
    scoreImpact: 5,
    check: (data) => data.twitterCard.hasTwitterCard && !data.twitterCard.hasTwitterTitle,
  },

  {
    ...
    severity: "warning",
    scoreImpact: 5,
    check: (data) => data.twitterCard.hasTwitterCard && !data.twitterCard.hasTwitterDescription,
  },

  {
    ...
    severity: "warning",
    scoreImpact: 8,
    check: (data) => data.twitterCard.hasTwitterCard && !data.twitterCard.hasTwitterImage,
  },
...

  {
    ...
    severity: "low",
    scoreImpact: 2,
    check: (data) => data.twitterCard.hasTwitterCard && !data.twitterCard.hasTwitterSite,
  },

  {
    ...
    severity: "low",
    scoreImpact: 2,
    check: (data) => data.twitterCard.hasTwitterCard && !data.twitterCard.hasTwitterCreator,
  },
...

  {
    ...
    severity: "info",
    scoreImpact: 0,
    check: (data) => data.twitterCard.hasTwitterPlayer && !data.twitterCard.hasTwitterPlayer,
  },
];
