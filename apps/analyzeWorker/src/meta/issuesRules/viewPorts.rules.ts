...
export const viewportRules: RulesType<PageMetaAnalysis, MetaIssueCode>[] = [
  // ===========================
  // Existence
  // ===========================
...

  {
    ...
    severity: "warning",
    scoreImpact: 10,
    check: (data) => data.viewport.hasViewport && !data.viewport.hasViewportWidth,
  },

  {
    ...
    severity: "warning",
    scoreImpact: 5,
    check: (data) => data.viewport.hasViewport && !data.viewport.hasInitialScale,
  },
...

  {
    ...
    severity: "high",
    scoreImpact: 15,
    check: (data) => data.viewport.hasUserScalable || data.viewport.hasMaximumScale,
  },
...

  {
    ...
    severity: "info",
    scoreImpact: 0,
    check: (data) => data.viewport.hasViewport && !data.viewport.hasViewportFit,
  },

  {
    ...
    severity: "info",
    scoreImpact: 0,
    check: (data) => data.viewport.hasViewport && !data.viewport.hasInteractiveWidget,
  },
...

  {
    ...
    severity: "info",
    scoreImpact: 0,
    check: (data) => data.viewport.hasMinimumScale,
  },

  {
    ...
    severity: "warning",
    scoreImpact: 5,
    check: (data) => data.viewport.hasMaximumScale,
  },
];
