...
export const OPEN_GRAPH_RECOMMENDATIONS = {
  [META_ISSUE_CODES.MISSING_OPEN_GRAPH]: {
    ...
    documentationLinks: [META_DOCUMENTATION.OPEN_GRAPH_PROTOCOL],
  },
  ...
  [META_ISSUE_CODES.MISSING_OG_LOCALE]: {
    ...
    howToFix: ["Add an og:locale property.", "Use the appropriate locale format such as en_US."],
    documentationLinks: [META_DOCUMENTATION.OPEN_GRAPH_PROTOCOL],
  },
  ...
  [META_ISSUE_CODES.MISSING_OG_VIDEO]: {
    ...
    whyItMatters: "Video metadata enables richer previews on supported social platforms.",
    howToFix: [
  ...
  [META_ISSUE_CODES.MISSING_OG_AUDIO]: {
    ...
    whyItMatters: "Audio metadata improves previews for pages whose primary content is audio.",
    howToFix: [
