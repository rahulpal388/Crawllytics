export const META_ISSUE_CODES = {
  ...
  INDEXIFEMBEDDED_WITHOUT_NOINDEX: "INDEXIFEMBEDDED_WITHOUT_NOINDEX",
  ...
  MISSING_TWITTER_CARD_TYPE: "MISSING_TWITTER_CARD_TYPE",

  MISSING_TWITTER_TITLE: "MISSING_TWITTER_TITLE",
  MISSING_TWITTER_DESCRIPTION: "MISSING_TWITTER_DESCRIPTION",

  MISSING_TWITTER_IMAGE: "MISSING_TWITTER_IMAGE",

  MISSING_TWITTER_SITE: "MISSING_TWITTER_SITE",
  MISSING_TWITTER_CREATOR: "MISSING_TWITTER_CREATOR",
  MISSING_TWITTER_PLAYER: "MISSING_TWITTER_PLAYER",
  ...
  MISSING_VIEWPORT_WIDTH: "MISSING_VIEWPORT_WIDTH",

  MISSING_INITIAL_SCALE: "MISSING_INITIAL_SCALE",

  INVALID_MINIMUM_SCALE: "INVALID_MINIMUM_SCALE",

  INVALID_MAXIMUM_SCALE: "INVALID_MAXIMUM_SCALE",

  USER_ZOOM_DISABLED: "USER_ZOOM_DISABLED",

  MISSING_VIEWPORT_FIT: "MISSING_VIEWPORT_FIT",

  MISSING_INTERACTIVE_WIDGET: "MISSING_INTERACTIVE_WIDGET",
  ...
  MISSING_HREFLANG_RETURN_LINK: "MISSING_HREFLANG_RETURN_LINK",
  ...
  MULTIPLE_FAVICONS: "MULTIPLE_FAVICONS",

  // ==========================================================
  // Resource Hints
  // ==========================================================

  MISSING_PRECONNECT: "MISSING_PRECONNECT",

  MISSING_DNS_PREFETCH: "MISSING_DNS_PREFETCH",

  MISSING_PRELOAD: "MISSING_PRELOAD",

  MISSING_PREFETCH: "MISSING_PREFETCH",

  MISSING_MODULE_PRELOAD: "MISSING_MODULE_PRELOAD",

  // ==========================================================
  // Manifest
  // ==========================================================

  MISSING_WEB_MANIFEST: "MISSING_WEB_MANIFEST",
...
export type MetaIssueCode = (typeof META_ISSUE_CODES)[keyof typeof META_ISSUE_CODES];
