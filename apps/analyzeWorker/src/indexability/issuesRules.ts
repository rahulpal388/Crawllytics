...
export const indexabilityIssuesRules: RulesType<PageIndexabilityType, IndexabilityIssueCode>[] = [
  // ===========================
  // HTTP Status
  // ===========================
...

  {
    ...
    severity: "critical",
    scoreImpact: 20,
    check: (data) => data.statusCode >= 400 && data.statusCode < 500 && data.statusCode !== 404,
  },

  {
    ...
    severity: "critical",
    scoreImpact: 25,
    check: (data) => data.statusCode >= 500 && data.statusCode < 600,
  },
...

  {
    ...
    severity: "critical",
    scoreImpact: 20,
    check: (data) => data.metaRobots.includes("none"),
  },
...

  {
    ...
    severity: "low",
    scoreImpact: 2,
    check: (data) => data.metaRobots.includes("nosnippet"),
  },

  {
    ...
    severity: "low",
    scoreImpact: 2,
    check: (data) => data.metaRobots.includes("noarchive"),
  },
...

  {
    ...
    severity: "critical",
    scoreImpact: 20,
    check: (data) => data.xRobotsTag.includes("noindex"),
  },

  {
    ...
    severity: "critical",
    scoreImpact: 20,
    check: (data) => data.xRobotsTag.includes("none"),
  },

  {
    ...
    severity: "warning",
    scoreImpact: 5,
    check: (data) => data.xRobotsTag.some((v) => v.startsWith("unavailable_after")),
  },

  {
    ...
    severity: "low",
    scoreImpact: 2,
    check: (data) => data.xRobotsTag.includes("nosnippet"),
  },

  {
    ...
    severity: "low",
    scoreImpact: 2,
    check: (data) => data.xRobotsTag.includes("noarchive"),
  },
...

  {
    ...
    scoreImpact: 10,
    check: (data) =>
      (data.metaRobots.includes("index") && data.metaRobots.includes("noindex")) ||
      (data.xRobotsTag.includes("index") && data.xRobotsTag.includes("noindex")),
  },

  {
    ...
    scoreImpact: 10,
    check: (data) =>
      (data.metaRobots.includes("index") && data.xRobotsTag.includes("noindex")) ||
      (data.metaRobots.includes("noindex") && data.xRobotsTag.includes("index")),
  },
...

  {
    ...
    severity: "warning",
    scoreImpact: 5,
    check: (data) => data.canonicalUrl.some((c) => c.isRelativeUrl),
  },

  {
    ...
    severity: "high",
    scoreImpact: 10,
    check: (data) => data.canonicalUrl.some((c) => !c.isValidUrl),
  },

  {
    ...
    severity: "warning",
    scoreImpact: 5,
    check: (data) => data.canonicalUrl.some((c) => !c.isHttps),
  },

  {
    ...
    severity: "warning",
    scoreImpact: 5,
    check: (data) => data.canonicalUrl.some((c) => c.isCrossPage),
  },

  {
    ...
    severity: "high",
    scoreImpact: 10,
    check: (data) => data.canonicalUrl.some((c) => c.isCrossDomain),
  },
...

  {
    ...
    severity: "warning",
    scoreImpact: 5,
    check: (data) => data.contentType === null,
  },

  {
    ...
    severity: "high",
    scoreImpact: 10,
    check: (data) => data.contentType !== null && data.contentType.startsWith("text/html"),
  },
];
