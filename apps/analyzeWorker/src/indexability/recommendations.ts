...
export const indexabilityRecommendations: Record<IndexabilityIssueCode, RecommendationType> = {
  [INDEXABILITY_ISSUES_CODES.SOFT_404]: {
    ...
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_HTTP_STATUS_CODES],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.NON_HTML_CONTENT]: {
    ...
    documentationLinks: [INDEXABILITY_DOCUMENTATION.MDN_CONTENT_TYPE],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.REDIRECT_PAGE]: {
    ...
    whyItMatters:
      "Redirect URLs are generally not indexed. Search engines index the destination URL instead.",
    howToFix: [
      "Use the destination URL in internal links.",
      "Replace redirected URLs in your sitemap.",
      "Minimize unnecessary redirects.",
    ],
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_REDIRECTS],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.META_NOINDEX]: {
    ...
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_META_ROBOTS],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.META_NOSNIPPET]: {
    ...
    howToFix: ["Remove the nosnippet directive unless intentionally required."],
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_META_ROBOTS],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.META_NOARCHIVE]: {
    ...
    howToFix: ["Remove the noarchive directive if caching should be allowed."],
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_META_ROBOTS],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.X_ROBOTS_NOINDEX]: {
    ...
    howToFix: ["Remove the noindex directive from the X-Robots-Tag header."],
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_X_ROBOTS_TAG],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.X_ROBOTS_NONE]: {
    ...
    howToFix: ["Remove the 'none' directive if unintended."],
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_X_ROBOTS_TAG],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.X_ROBOTS_UNAVAILABLE_AFTER]: {
    ...
    howToFix: ["Verify the expiration date.", "Remove the directive if unnecessary."],
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_X_ROBOTS_TAG],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.X_ROBOTS_NOARCHIVE]: {
    ...
    howToFix: ["Remove the noarchive directive if cached pages should be available."],
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_X_ROBOTS_TAG],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.CONFLICTING_ROBOTS_DIRECTIVES]: {
    ...
    howToFix: ["Use one consistent indexing policy.", "Remove conflicting robots directives."],
    documentationLinks: [
  ...
  [INDEXABILITY_ISSUES_CODES.META_AND_X_ROBOTS_CONFLICT]: {
    ...
    howToFix: ["Ensure both robots directives specify the same indexing policy."],
    documentationLinks: [
      INDEXABILITY_DOCUMENTATION.GOOGLE_META_ROBOTS,
      INDEXABILITY_DOCUMENTATION.GOOGLE_X_ROBOTS_TAG,
    ],
  ...
  [INDEXABILITY_ISSUES_CODES.MISSING_CANONICAL]: {
    ...
    whyItMatters:
      "Search engines may have difficulty determining the preferred version of duplicate pages.",
    howToFix: [
      "Add a self-referencing canonical tag.",
      "Ensure the canonical points to the preferred URL.",
    ],
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_CANONICAL],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.MULTIPLE_CANONICAL_TAGS]: {
    ...
    howToFix: ["Keep only one canonical tag per page.", "Remove duplicate canonical elements."],
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_CANONICAL],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.RELATIVE_CANONICAL_URL]: {
    ...
    howToFix: ["Use an absolute canonical URL including the protocol and hostname."],
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_CANONICAL],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.INVALID_CANONICAL_URL]: {
    ...
    howToFix: ["Correct the canonical URL.", "Ensure it is a valid absolute URL."],
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_CANONICAL],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.NON_HTTPS_CANONICAL]: {
    ...
    howToFix: ["Update the canonical URL to use HTTPS."],
    documentationLinks: [INDEXABILITY_DOCUMENTATION.GOOGLE_CANONICAL],
  },
  ...
  [INDEXABILITY_ISSUES_CODES.MISSING_CONTENT_TYPE]: {
    ...
    whyItMatters:
      "Search engines use the Content-Type header to understand how the resource should be processed.",
    howToFix: [
