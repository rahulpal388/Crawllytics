...
export function securityAnalysis(gatherInfo: GatherInfoType): PageSecurityAnalysis {
    ...
    const xContentTypeOptionsPresent = gatherInfo.networkInfo.responseHeaders.xContentTypeOptions !== null;
    const referrerPolicyPresent = gatherInfo.networkInfo.responseHeaders.referrerPolicy !== null;
    const permissionsPolicyPresent = gatherInfo.networkInfo.responseHeaders.permissionsPolicy !== null;
