...
export const crawlabilityRecommendations: Record<CrawlabilityIssueCode, RecommendationType> = {
  [CRAWLABILITY_ISSUE_CODES.HTTP_STATUS_3XX]: {
    title: "Page redirects",
    description: "The requested URL redirects to another URL.",
    whyItMatters: "Redirects increase crawl time and may slow users if used excessively.",
    howToFix: [
  ...
  [CRAWLABILITY_ISSUE_CODES.HTTP_STATUS_5XX]: {
    ...
    whyItMatters: "Search engines may stop crawling pages that repeatedly return server errors.",
    howToFix: [
  ...
  [CRAWLABILITY_ISSUE_CODES.REDIRECT_LOOP]: {
    ...
    whyItMatters: "Neither users nor search engines can reach the destination page.",
    howToFix: ["Break the redirect cycle.", "Redirect directly to the final destination."],
  ...
  [CRAWLABILITY_ISSUE_CODES.REDIRECT_CHAIN]: {
    ...
    whyItMatters: "Long redirect chains waste crawl budget and increase latency.",
    howToFix: ["Reduce the number of redirects.", "Point directly to the final URL."],
    documentationLinks: CRAWLABILITY_DOCUMENTATION.REDIRECTS,
  },
  ...
  [CRAWLABILITY_ISSUE_CODES.LONG_REDIRECT_CHAIN]: {
    ...
    whyItMatters: "Long redirect chains reduce crawl efficiency and page loading speed.",
    howToFix: [
  ...
  [CRAWLABILITY_ISSUE_CODES.ROBOTS_TXT_BLOCKED]: {
    ...
    whyItMatters: "Search engines may not crawl this page.",
    howToFix: [
  ...
  [CRAWLABILITY_ISSUE_CODES.ROBOTS_USER_AGENT_NOT_MATCHED]: {
    ...
    whyItMatters: "This is informational and usually not an issue.",
    howToFix: [],
    documentationLinks: CRAWLABILITY_DOCUMENTATION.ROBOTS_TXT,
  },
  ...
  [CRAWLABILITY_ISSUE_CODES.NO_INTERNAL_INCOMING_LINKS]: {
    ...
    whyItMatters: "The page may become orphaned and difficult for search engines to discover.",
    howToFix: ["Add relevant internal links from other pages."],
  ...
  [CRAWLABILITY_ISSUE_CODES.NO_INTERNAL_OUTGOING_LINKS]: {
    ...
    whyItMatters: "Internal linking helps users and search engines discover related content.",
    howToFix: ["Add relevant internal links where appropriate."],
    documentationLinks: CRAWLABILITY_DOCUMENTATION.INTERNAL_LINKING,
  },
  ...
  [CRAWLABILITY_ISSUE_CODES.SLOW_DNS_LOOKUP]: {
    ...
    howToFix: ["Use a faster DNS provider.", "Optimize DNS configuration."],
  ...
  [CRAWLABILITY_ISSUE_CODES.SLOW_TCP_CONNECTION]: {
    ...
    howToFix: ["Reduce network latency.", "Optimize hosting infrastructure."],
    documentationLinks: CRAWLABILITY_DOCUMENTATION.PERFORMANCE,
  },
  ...
  [CRAWLABILITY_ISSUE_CODES.SLOW_TLS_HANDSHAKE]: {
    ...
    howToFix: ["Optimize TLS configuration.", "Enable modern TLS protocols."],
    documentationLinks: CRAWLABILITY_DOCUMENTATION.PERFORMANCE,
  },
  ...
  [CRAWLABILITY_ISSUE_CODES.HIGH_RESPONSE_TIME]: {
    ...
    howToFix: ["Improve server performance.", "Optimize application code."],
    documentationLinks: CRAWLABILITY_DOCUMENTATION.PERFORMANCE,
  },
  ...
  [CRAWLABILITY_ISSUE_CODES.META_ROBOTS_NOINDEX]: {
    ...
    howToFix: ["Remove the noindex directive if the page should be indexed."],
  ...
  [CRAWLABILITY_ISSUE_CODES.META_ROBOTS_NOFOLLOW]: {
    ...
    howToFix: ["Remove the nofollow directive if appropriate."],
    documentationLinks: CRAWLABILITY_DOCUMENTATION.ROBOTS_META,
  },
  ...
  [CRAWLABILITY_ISSUE_CODES.X_ROBOTS_NOINDEX]: {
    ...
    howToFix: ["Remove the noindex X-Robots-Tag if indexing is intended."],
    documentationLinks: CRAWLABILITY_DOCUMENTATION.ROBOTS_META,
  },
  ...
  [CRAWLABILITY_ISSUE_CODES.MISSING_CANONICAL]: {
    ...
    howToFix: ["Add a self-referencing canonical tag."],
  ...
  [CRAWLABILITY_ISSUE_CODES.MULTIPLE_CANONICAL]: {
    ...
    howToFix: ["Keep only one canonical tag per page."],
    documentationLinks: CRAWLABILITY_DOCUMENTATION.CANONICAL,
  },
  ...
  [CRAWLABILITY_ISSUE_CODES.NOT_IN_SITEMAP]: {
    ...
    howToFix: ["Add the page to the XML sitemap if it should be indexed."],
