    ...
    */
    ...
    for (const url of internalUrl) {
        ...
        */
        ...
        if (msg.limit.type === "pages" && crawlStore.linkInfo.totalUrl >= crawlStore.linkInfo.limit.value) {
            continue;
        }
        const currValue = msg.limit.type === "depth" ? msg.limit.currValue + 1 : crawlStore.linkInfo.totalUrl + 1;
