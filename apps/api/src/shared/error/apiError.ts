...
export const ApiError = {
    ...
    userAlreadyExists: () =>
        new AppError("USER_ALREADY_EXISTS", 409, "User already exists"),
    invalidCredentials: (msg: string) =>
        new AppError("INVALID_CREDENTIALS", 401, msg),
    userNotFound: () =>
        new AppError("USER_NOT_FOUND", 404, "User not found"),
    linkExpired: () =>
        new AppError("EXPIRED_LINK", 410, "Link has expired"),
    ...
    internal: (msg = "Something went wrong") =>
        new AppError("INTERNAL_SERVER_ERROR", 500, msg),
};